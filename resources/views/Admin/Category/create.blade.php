            ...
            <div class="card-body">
                ...
                <form action="{{route('Category.store')}}" method="POST" class="mt-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('category_name')is-invalid @enderror" name="category_name" placeholder="Enter Your student Name" value="{{old('category_name')}}" required>
                        @error('category_name')
